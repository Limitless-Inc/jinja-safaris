...
VALUES
  ...
  ('Skydiving', 'Jump from 10,000 feet above the Nile', 'Experience the ultimate thrill with a tandem skydive over the beautiful Nile River and Jinja landscape.', 300, 350, '/images/skydiving.jpg'),
  ('Nile Tubing', 'Relax and float down the Nile', 'A more relaxed water adventure perfect for families. Float down the calm sections of the Nile River.', 35, 45, '/images/tubing.jpg'),
  ('Jinja Trekking', 'Explore the natural beauty of Jinja', 'Guided trekking tours through the lush landscapes surrounding Jinja. Suitable for all fitness levels.', 20, 25, '/images/trekking.jpg'),
  ('Bird Watching', 'Discover Uganda''s diverse bird species', 'Join our expert guides to spot over 200 bird species in the Jinja region. Perfect for nature enthusiasts.', 25, 30, '/images/birdwatching.jpg');
